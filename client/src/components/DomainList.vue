    ...
    domains() {
      ...
      for (const prefix of this.prefixes) {
        for (const sufix of this.sufixes) {
          ...
          const checkout = `https://checkout.hostgator.com.br/?a=add&sld=${url}&tld=.com&domaincycle=2&titanDomain=1&_ga=2.43835751.398059487.1626459855-877840163.1618861799`;
          domains.push({
            name: name,
            checkout: checkout,
          });
